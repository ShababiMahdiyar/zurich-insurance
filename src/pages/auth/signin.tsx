...
export default function SignIn() {
  return (
    <section className="flex bg-gray-50 dark:bg-gray-900 h-screen justify-center ">
      <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 mt-[10%] dark:bg-gray-800 dark:border-gray-700 h-44">
        <h5 className="mb-3 text-base font-semibold text-gray-900 md:text-xl dark:text-white">
          Login to the dashboard
        </h5>
        <p className="text-sm font-normal text-gray-500 dark:text-gray-400">
          Use your google account to login to the dashboard
        </p>
